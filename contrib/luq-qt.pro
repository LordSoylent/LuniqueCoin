...
RESOURCES += src/qt/luq.qrc src/qt/luq_locale.qrc

TRANSLATIONS += src/qt/locale/luq_bg.ts \
                src/qt/locale/luq_de.ts \
                src/qt/locale/luq_en.ts \
                src/qt/locale/luq_es.ts \
                src/qt/locale/luq_fi.ts \
                src/qt/locale/luq_fr.ts \
                src/qt/locale/luq_it.ts \
                src/qt/locale/luq_ja.ts \
                src/qt/locale/luq_pl.ts \
                src/qt/locale/luq_pt.ts \
                src/qt/locale/luq_ru.ts \
                src/qt/locale/luq_sk.ts \
                src/qt/locale/luq_sv.ts \
                src/qt/locale/luq_vi.ts \
                src/qt/locale/luq_zh_CN.ts \
                src/qt/locale/luq_zh_TW.ts
