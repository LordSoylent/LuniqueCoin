...
#if defined(NDEBUG)
#error "LUQ cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "LUQ Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	if(nHeight <= 1 && nHeight > 0) {
        nSubsidy = 30000 * COIN;} 
	else if (nHeight > 1 && nHeight <= 181) {nSubsidy = 0.1 * COIN;} 
	else if (nHeight > 181 && nHeight <= 4502) {nSubsidy = 0.2 * COIN;} 
	else if (nHeight > 4502 && nHeight <= 76503) {nSubsidy = 20 * COIN;} 
	else if (nHeight > 76503 && nHeight <= 522904) {nSubsidy = 1.5 * COIN;} 
	else if (nHeight > 522904) {nSubsidy = 0.18 * COIN;}
	return nSubsidy;
}
...
{
	int64_t ret = 0;
	if(nHeight <= 1 && nHeight > 0) {ret = blockValue * 0.9;} 
	else if (nHeight > 1 && nHeight <= 181) {ret = blockValue * 0.9;} 
	else if (nHeight > 181 && nHeight <= 4502) {ret = blockValue * 0.9;} 
	else if (nHeight > 4502 && nHeight <= 76503) {ret = blockValue * 0.9;} 
	else if (nHeight > 76503 && nHeight <= 522904) {ret = blockValue * 0.9;} 
	else if (nHeight > 522904) {ret = blockValue * 0.9;}
	return ret;
}
