...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* LUQ features */
        {"luq", "masternode", &masternode, true, true, false},
        {"luq", "masternodelist", &masternodelist, true, true, false},
        {"luq", "mnbudget", &mnbudget, true, true, false},
        {"luq", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"luq", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"luq", "mnsync", &mnsync, true, true, false},
        {"luq", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use luqd, or the -server option to luq-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> luq-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:30001/\n";
}
