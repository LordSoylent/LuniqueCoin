                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("LUNIQUE-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a LUQ address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and luq: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About LUQ Core"), this);
    aboutAction->setStatusTip(tr("Show information about LUQ Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for LUQ"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your LUQ addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified LUQ addresses"));
    ...
    openAction->setStatusTip(tr("Open a LUQ: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the LUQ Core help message to get a list with possible LUQ command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("LUQ Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to LUQ network", "", count));
}
...
{
    QString strTitle = tr("LUQ Core"); // default title
